...
export const ContactSection = ({
  ...
  order: number;
  ref: React.RefObject<HTMLElementTagNameMap['section']>;
}) => {
    ...
    <>
      ...
      >
        ...
        <ContentContainer>
          ...
          <PostBoxContainer>
            <PostBoxTopImg src="/postbox/postbox-top.svg"/>
            <PostBoxBottomImg src="/postbox/postbox-bottom.svg" />
          </PostBoxContainer>
        </ContentContainer>
      </Section>
    </>
